...
mek = mek.messages[0]
 ...
 //_______________________________________________________________________________________________________________________________________________________   //		      
  ...
  if ( file.filesize > 1500000) return await conn.sendMessage(from , { text: mx }, { quoted: mek } )
...
// _ _ _ _ _ _ _ _ __  _ _ _ _ _ _  __  _ _ _ __ _  __ _  _ _ _ _ __ _ _  __  __ _  _ __  _ __ _ _ _  _ __ _  _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ __  __ _  __ _ _ _ _   //   		      
	 ...
	 const name = data.data.name		
	  ...
	  if ( app_link.size.replace('GB' , '') > 2) return await conn.sendMessage(from , { text: 'التطبيق الذي تريده حجمه كبير لا يمكن لبوبيز ان يرسله الحد الاقصى هو 200 ميغا' }, { quoted: mek } )
...
│  ⸙ .alive      وش لبوت خدام ولا لا
│  ⸙ .song         الى بغيتي تانسطالي شي موسيقى 
╰────────────────────╯
https://chat.whatsapp.com/H7eZgKBB9LeGQJk4jZXxWL		      await conn.sendMessage(from , { text: msg }, { quoted: mek } )  
